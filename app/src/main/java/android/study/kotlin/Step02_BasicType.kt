...
fun main(){
    ...
    var b:Float
    var c:Long
    var d:Int // java 에서는 Integer에 해당하는 type
    var e:Short
    var f:Byte
    //숫자 대입
    a=10.1
    ...
    */
    ...
    //문자열 배열
    var anumals:Array<String> = arrayOf<String>("cat","dog","elephant")
    ...
    /*
        ...
        kotlin 에서는 수정가능한 List와 수정 불가능한 List (readonly) 가 있다.
        수정불가능한 List가 속도가 더 빠르다.
     */
    var list1 = listOf<String>("사자", "고양이", "원숭이")

    // 아래의 한줄이 java 에서 List<String> list2=new ArrayList<String>(); 과 같다.
    var list2 = mutableListOf<String>("사자", "고양이", "원숭이")
